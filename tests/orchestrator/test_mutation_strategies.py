#!/usr/bin/env python3
"""
Tests for mutation strategy methods in lafleur/orchestrator.py.

This module contains unit tests for mutation strategy selection and execution
methods in the LafleurOrchestrator class.
"""
...
class TestApplyMutationStrategy(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Mock ast_mutator
        self.orchestrator.ast_mutator = MagicMock()
        self.orchestrator.ast_mutator.transformers = [MagicMock, MagicMock]
    ...
    def test_seeds_random_generators(self):
        ...
        self.orchestrator._run_deterministic_stage = self.mock_det
    ...
    def test_records_strategy_attempts(self):
        ...
        self.assertIn("deterministic", self.orchestrator.score_tracker.attempts)
        self.assertIn("havoc", self.orchestrator.score_tracker.attempts)
        self.assertIn("spam", self.orchestrator.score_tracker.attempts)
    ...
    def test_adds_seed_to_mutation_info(self):
        ...
        _, mutation_info = self.orchestrator.apply_mutation_strategy(tree, seed=12345)
    ...
    def test_returns_mutated_ast_and_info(self):
        ...
        result_ast, result_info = self.orchestrator.apply_mutation_strategy(tree, seed=42)
...
class TestRunDeterministicStage(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.orchestrator = LafleurOrchestrator.__new__(LafleurOrchestrator)
        self.orchestrator.ast_mutator = MagicMock()
        self.orchestrator.ast_mutator.transformers = [MagicMock]
...
class TestRunHavocStage(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.orchestrator.ast_mutator.transformers = [self.mock_transformer]

        # Mock score_tracker
        self.orchestrator.score_tracker = MagicMock()
        self.orchestrator.score_tracker.attempts = defaultdict(int)
        self.orchestrator.score_tracker.get_weights.return_value = [1.0]
    ...
    def test_records_transformer_attempts(self):
        ...
        self.assertEqual(self.orchestrator.score_tracker.attempts["MockTransformer"], 3)
