...
class _JitMetrics:
    """Mutable accumulator for JIT executor metrics during namespace scanning."""
    ...
    __slots__ = (
        ...
        "min_code_size",
        "max_exit_density",
        "delta_max_exit_count",
        "delta_max_exit_density",
        "delta_total_exits",
        "delta_new_executors",
        "delta_new_zombies",
        "introspection_error_logged",
    )

    def __init__(self) -> None:
        self.executor_count: int = 0
        self.functions_scanned: int = 0
        self.zombie_traces: int = 0
        self.valid_traces: int = 0
        self.warm_traces: int = 0
        self.max_exit_count: int = 0
        self.max_chain_depth: int = 0
        self.min_code_size: float = float("inf")
        self.max_exit_density: float = 0.0
        self.delta_max_exit_count: int = 0
        self.delta_max_exit_density: float = 0.0
        self.delta_total_exits: int = 0
        self.delta_new_executors: int = 0
        self.delta_new_zombies: int = 0
        self.introspection_error_logged: bool = False

    def to_dict(self, include_deltas: bool = False) -> dict:
        """Convert to the result dict format expected by callers."""
        result = {
